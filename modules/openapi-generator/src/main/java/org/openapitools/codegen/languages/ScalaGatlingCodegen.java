...
public class ScalaGatlingCodegen extends AbstractScalaCodegen implements CodegenConfig {
    ...
    public String getHelp() {
        return "Generates a Gatling script including to be used with continuous performance testting dashboard";
    }
    ...
    public void processOpts() {
        ...
        if (this.additionalProperties.containsKey("javaClientVersion")) {
            javaClientVersion = this.additionalProperties.get("javaClientVersion").toString();
        } else {
            javaClientVersion = "1.5.0-SNAPSHOT";
        }
        ...
        this.additionalProperties.put("javaClientVersion", javaClientVersion);
