...
import static org.openapitools.codegen.languages.XojoClientCodegen.SERIALIZATION_LIBRARY_DESC;
...
public class KotlinClientCodegen extends AbstractKotlinCodegen {
    ...
    private void processJVMVolleyLibrary(String infrastructureFolder, String requestFolder, String authFolder) {
        ...
        if (super.getSerializationLibrary() != SERIALIZATION_LIBRARY_TYPE.gson) {
